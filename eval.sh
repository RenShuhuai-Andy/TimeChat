...
TASK='dvc'
ANNO_DIR='data/YouCook2-BB/YouCook2_asr_denseCap'
...
#TASK='tvg'
#ANNO_DIR='data/Charades/charades_annotation'
...
#TASK='vhd'
#ANNO_DIR='data/QVhighlights/'
#VIDEO_DIR='data/QVhighlights/videos/val/'
#DATASET='qvhighlights'
#SPLIT='val'
#PROMPT_FILE="prompts/${TASK}_description.txt"
#GT_FILE="${ANNO_DIR}/annotations_raw/highlight_${SPLIT}_release.jsonl"
