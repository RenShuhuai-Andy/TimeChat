...
## News
- [24.06.04] <span style="color:red;">[NEW!]</span> Release evaluation results of TimeChat-7b on several VideoLLM benchmarks (e.g., MVBench, TempCompass, etc.), see [docs](./docs/EVAL.md).
