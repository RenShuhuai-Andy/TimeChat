...
- [24.06.04] ![NEW!](https://img.shields.io/badge/NEW!-red) Release evaluation results of TimeChat-7b on several VideoLLM benchmarks (e.g., MVBench, TempCompass, etc.), see [EVAL.md](./docs/EVAL.md).
