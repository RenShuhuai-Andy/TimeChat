...
from utils import compute_average_precision_detection, \
    compute_temporal_iou_batch_cross, compute_temporal_iou_batch_paired, load_jsonl, load_json, get_ap
...
def eval_main():
    ...
    parser.add_argument("--pred_file", type=str, help="path to generated prediction file")
    parser.add_argument("--gt_file", type=str, help="path to GT file", default="/home/yaolinli/dataset/QVhighlights/annotations_raw/highlight_val_release.jsonl")
    parser.add_argument("--save_path", type=str, help="path to save the results", default="metrics.json")
    parser.add_argument("--not_verbose", action="store_true")
    args = parser.parse_args()

    verbose = not args.not_verbose
    submission = load_json(args.pred_file)
    ...
    print("HL-min-VeryGood-mAP: ", results["brief"]["HL-min-VeryGood-mAP"])
    print("HL-min-VeryGood-Hit1: ", results["brief"]["HL-min-VeryGood-Hit1"])
